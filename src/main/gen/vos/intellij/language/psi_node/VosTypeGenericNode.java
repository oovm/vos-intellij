...
public class VosTypeGenericNode extends ASTWrapperPsiElement implements VosTypeGeneric {

  public VosTypeGenericNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<VosTypeSymbol> getTypeSymbolList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, VosTypeSymbol.class);
  }
