...
public class JssClassStatementNode extends ASTWrapperPsiElement implements JssClassStatement {

  public JssClassStatementNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JssClassBlock getClassBlock() {
    return findChildByClass(JssClassBlock.class);
  }
