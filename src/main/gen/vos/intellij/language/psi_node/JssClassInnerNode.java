...
public class JssClassInnerNode extends ASTWrapperPsiElement implements JssClassInner {
  ...
  @Override
  @NotNull
  public List<JssClassBound> getClassBoundList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JssClassBound.class);
  }

  @Override
  @NotNull
  public List<JssClassField> getClassFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, JssClassField.class);
  }
