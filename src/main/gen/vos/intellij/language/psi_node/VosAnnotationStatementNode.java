...
public class VosAnnotationStatementNode extends MixinAnnotation implements VosAnnotationStatement {

  public VosAnnotationStatementNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public VosAnnotation getAnnotation() {
    return findNotNullChildByClass(VosAnnotation.class);
  }
