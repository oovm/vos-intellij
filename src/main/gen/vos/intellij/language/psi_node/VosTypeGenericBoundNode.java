...
public class VosTypeGenericBoundNode extends ASTWrapperPsiElement implements VosTypeGenericBound {

  public VosTypeGenericBoundNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public VosCompare getCompare() {
    return findChildByClass(VosCompare.class);
  }
