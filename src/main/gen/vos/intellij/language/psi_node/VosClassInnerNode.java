...
public class VosClassInnerNode extends ASTWrapperPsiElement implements VosClassInner {

  public VosClassInnerNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public VosClassField getClassField() {
    return findChildByClass(VosClassField.class);
  }
