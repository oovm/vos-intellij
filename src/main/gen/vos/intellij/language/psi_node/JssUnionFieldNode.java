...
public class JssUnionFieldNode extends ASTWrapperPsiElement implements JssUnionField {

  public JssUnionFieldNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JssIntegerSigned getIntegerSigned() {
    return findChildByClass(JssIntegerSigned.class);
  }
