...
public class JssUnionInnerNode extends ASTWrapperPsiElement implements JssUnionInner {

  public JssUnionInnerNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JssVisitor visitor) {
    visitor.visitUnionInner(this);
  }
  ...
  @Override
  @Nullable
  public JssUnionField getUnionField() {
    return findChildByClass(JssUnionField.class);
  }
