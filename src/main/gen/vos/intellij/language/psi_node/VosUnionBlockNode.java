...
public class VosUnionBlockNode extends ASTWrapperPsiElement implements VosUnionBlock {

  public VosUnionBlockNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<VosUnionInner> getUnionInnerList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, VosUnionInner.class);
  }
